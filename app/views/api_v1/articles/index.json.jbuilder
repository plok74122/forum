json.meta do
  ...
  json.next_url (@article.last_page?) ? nil : v1_articles_url(:page => @article.next_page)
  json.previous_url (@article.first_page?) ? nil : v1_articles_url(:page => @article.prev_page)
end
json.results do
